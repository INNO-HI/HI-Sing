...
const faqs: Faq[] = [
  // 제작
  {
    ...
    a: 'mp3, m4a, wav, webm 등 대부분의 음성 파일을 지원합니다. 전화 녹음, 영상 속 목소리, 일상 대화 녹음 모두 가능합니다. 최소 60초부터 접수되지만, 1분 이상이면 더 자연스러운 결과물이 나옵니다. 한 분 목소리가 주된 음성이면 충분하고, 약간의 배경음·잡음은 허용됩니다.',
  },
  {
    category: '제작',
    q: '여러 사람 목소리가 섞여 있어도 되나요?',
    a: '네, 괜찮습니다. 단, 한 분의 목소리가 주된 음성으로 들리는 파일이 가장 잘 나옵니다. 여러 분이 번갈아 많이 등장하는 경우 품질이 낮아질 수 있어, 주된 화자 한 분을 주문 시 알려주세요.',
  },
  {
    category: '제작',
    q: '본인 목소리로도 만들 수 있나요?',
  ...
  },
  {
    category: '저작권·AI',
    q: '목소리가 진짜 똑같이 재현되나요?',
    a: '음성 샘플의 톤, 억양, 음색을 분석해 자연스러운 보컬로 합성합니다. 100% 완벽한 재현을 보장하지는 않으며, 샘플의 품질·분량·잡음 수준에 따라 결과가 달라질 수 있습니다. 결과가 기대와 다르면 1회 무료 수정으로 조정해드립니다.',
  },
  {
    category: '저작권·AI',
    q: '타인의 목소리도 사용할 수 있나요?',
    a: '반드시 음성 주체(목소리 당사자)의 사전 동의가 필요합니다. 주문 시 음성 사용 권한 동의 체크박스에 동의하지 않으면 결제가 진행되지 않습니다. 동의 없이 타인의 음성을 업로드하거나 정치인·연예인·고인 등의 목소리를 사용하는 행위는 어떠한 경우에도 허용되지 않으며, 이로 인한 모든 책임은 이용자 본인에게 있습니다.',
  },
  {
    category: '저작권·AI',
    q: '업로드한 음성은 다른 곳에 사용되나요?',
    a: '아니요. 업로드하신 음성은 오직 주문하신 1곡의 노래 제작 목적으로만 사용되며, 그 외 어떠한 목적(외부 공유, 제3자 제공, 추가 학습 등)으로도 사용되지 않습니다. 제작 완료 후 30일이 지나면 서버에서 자동으로 영구 삭제됩니다.',
  },
  {
    category: '저작권·AI',
    q: '완성곡을 SNS에 올리거나 상업적으로 써도 되나요?',
    a: '완성곡은 개인 비상업 가족·지인 선물 용도로만 제공됩니다. SNS 공개 게시·유튜브 수익화·음원 유통·광고·방송 등 상업적 이용은 사전에 회사의 서면 동의를 받아주세요. 또한 사칭·허위정보·딥페이크 콘텐츠 제작 목적으로 결과물을 사용하는 것은 어떠한 경우에도 금지됩니다.',
  },
