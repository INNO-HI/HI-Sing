          ...
          <div className="space-y-10">
            ...
            <div>
              ...
              <section className="mb-6">
                ...
                <ol className="list-decimal pl-5 text-sm text-ink-muted leading-relaxed space-y-1">
                  ...
                  <li>회사는 AI 모델의 학습 데이터 및 알고리즘의 특성상 예상하지 못한 출력이 발생할 수 있으며, 이러한 경우 수정 또는 재작업으로 대응합니다.</li>
                </ol>
              </section>
              ...
              <section className="mb-6">
                ...
                <ol className="list-decimal pl-5 text-sm text-ink-muted leading-relaxed space-y-1">
                  ...
                  <li>이용자가 제공한 음성 데이터는 완성곡 제작 목적 외에는 사용되지 아니하며, 별도 동의 없이 AI 모델 학습에 활용되지 않습니다.</li>
                </ol>
              </section>
            ...
            <section className="pt-6 border-t border-neutral-200">
              <div className="bg-neutral-50 rounded-xl p-5 text-sm text-ink-muted space-y-1">
                ...
                <p>대표 전화: 010-8225-4024</p>
                <p>이메일: contact@innohi.ai.kr</p>
                <p>개인정보 보호책임자: 김민수 / 개인정보 보호 담당자: 한민우</p>
              </div>
              <p className="text-xs text-ink-faint mt-4">본 약관은 2026년 4월 10일부터 시행됩니다.</p>
            </section>
          </div>
        </div>
      </div>
